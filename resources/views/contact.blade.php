...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <div class="slider-area ">
        <!-- Mobile Menu -->
        <div class="single-slider slider-height2 d-flex align-items-center" style="background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(assets/img/hero/contact_hero.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
    ...
    <section class="contact-section">
            <div class="container">
                        ...
                        {!! Form::open(['url' => 'contact/submit', 'method'=>'post']) !!}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('subject', '', ['class'=>'form-control valid', 'placeholder'=>'Subject of Mail']) }}
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            {{ Form::label('message', 'message') }}
                                            {{ Form::textarea('message', '', ['class'=>'form-control valid', 'placeholder'=>'Message']) }}
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 offset-lg-1">
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-home"></i></span>
                            <div class="media-body">
                                <h3>71-75 Shelton Street
                                    Covent Garden
                                    </h3>
                                <p>London
                                    W2H 9JQ
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>matthew@southseashipyard.com</h3>
                            </div>
                        </div>
                    </div>
                    </div>
